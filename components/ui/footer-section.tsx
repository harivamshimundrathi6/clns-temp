      ...
      <div className="container mx-auto px-4 py-12 md:px-6 lg:px-8">
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t pt-8 text-center md:flex-row">
          <p className="text-sm text-muted-foreground">
            <button onClick={() => signOut({ callbackUrl: '/developer-login?callbackUrl=/dashboard/developer' })} className="cursor-text text-inherit hover:text-inherit bg-transparent border-none p-0 m-0 font-inherit outline-none">@2026 COBALT-AXIS.</button> All rights reserved.
          </p>
